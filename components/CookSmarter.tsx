...
export default function CookSmarter() {
  return (
    <div className="w-screen mt-24">
      <div className="container mx-auto bg-neutral-200 flex flex-col items-center justify-center gap-y-4 text-neutral-900 py-28 px-6 rounded-xl relative overflow-hidden">
